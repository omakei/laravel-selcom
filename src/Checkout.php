...
class Checkout
{
    ...
    private function makeCreateOrderLongPayload(
        ...
        'billing.address_1' => $billing_address_1,
        'billing.address_2' => $billing_address_2,
        'billing.city' => $billing_city,
        'billing.state_or_region' => $billing_state_or_region,
        'billing.postcode_or_pobox' => $billing_postcode_or_pobox,
        ...
        'shipping.state_or_region' => $shipping_state_or_region,
        'shipping.postcode_or_pobox' => $shipping_postcode_or_pobox,
